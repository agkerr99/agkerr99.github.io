...
leaflet() %>%
  ...
  addPolygons(
    ...
    label = ~paste0(
      ...
      "%Elderly persons or children (at elevated risk for heat-extreme impacts)"
    ),
  ...
  addLegend(
    ...
    title = "% Elderly persons or <br> children (at elevated risk for <br> heat-extreme impacts)"
  )
