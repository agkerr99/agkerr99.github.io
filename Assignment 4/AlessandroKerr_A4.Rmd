...
#   mutate(estimate2 = NA)
# 
# sc_edu_total2$estimate2[1] = sum(sc_edu_total2$estimate[1:8],sc_edu_total2$estimate[17:24])
# sc_edu_total2$estimate2[2] = sum(sc_edu_total2$estimate[9], sc_edu_total2$estimate[25])
# sc_edu_total2$estimate2[3] = sum(sc_edu_total2$estimate[10:12], sc_edu_total2$estimate[26:28])
# sc_edu_total2$estimate2[4] = sum(sc_edu_total2$estimate[13:16], sc_edu_total2$estimate[29:32])
# 
# sc_edu_total2$education[1:4] = c("Less than high school diploma", "High school graduate (includes equivalency)", "Some college or associate's degree", "Bachelor's degree or higher" )
# 
# sc_edu_total2 <- 
#   sc_edu_total2 %>%
#   mutate(estimate = estimate2) %>%
#   select(-estimate2) %>%
